...
# start tmux
# rechecks for interactive shell
...
if [ "$color_prompt" = yes ]; then
    ...
    PS1='\[\033[01;32m\]\u\[\033[00m\] \[\033[01;34m\]\w\[\033[00m\]\[\e[91m\]${PS1_CMD1}\[\e[0m\] \$ ';
else
    PS1='\w${PS1_CMD1} \$ ';
fi
...
# set editor to nvim
# e.g. tmux uses these to determine which keybinds to use
export EDITOR="/usr/bin/nvim"
export VISUAL="/usr/bin/nvim"

# access problems with temp file writing
